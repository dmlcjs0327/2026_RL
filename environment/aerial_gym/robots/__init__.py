...
from aerial_gym.config.robot_config.x500_config import X500Cfg, X500WithCameraLowResCfg
...
robot_registry.register("x500_with_camera_lowres", BaseMultirotor, X500WithCameraLowResCfg)
...
robot_registry.register("base_quadrotor_with_camera_lowres", BaseMultirotor, BaseQuadWithCameraLowResCfg)
