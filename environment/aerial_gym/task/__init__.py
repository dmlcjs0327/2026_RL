...
from aerial_gym.config.task_config.position_setpoint_gc_task_config import (
    task_config as position_setpoint_gc_task_config,
)
...
task_registry.register_task(
    ...
    PositionSetpointGCTask,
    position_setpoint_gc_task_config,
)
