...
from aerial_gym.config.sensor_config.camera_config.depth_camera_lowres_config import (
    DepthCameraLowResConfig,
)
...
class BaseQuadWithCameraLowResCfg(BaseQuadCfg):
    """Depth camera at 64×64 for faster image-based training (Warp + CNN)."""
    class sensor_config(BaseQuadCfg.sensor_config):
        enable_camera = True
        camera_config = DepthCameraLowResConfig
