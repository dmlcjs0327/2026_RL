...
1. Download and install Aerial Gym Simulator
    ...
    git clone git@github.com:dmlcjs0327/SHVD.git
    # or over HTTPS
    # git clone https://github.com/dmlcjs0327/SHVD.git
...
1. Test an example environment
    ```bash
    cd ~/workspaces/aerial_gym_ws/src/SHVD/aerial_gym/examples
