...
문서는 용도별로 하위 디렉터리에 정리되어 있습니다.

---

## 사용법·디렉터리 참조 (우선 참고)

- **[../USAGE.md](../USAGE.md)** — Aerial Gym(Isaac Gym 기반) 사용법, **로컬 디렉터리 구조**, 실행 진입점(runner.py, train.py), 태스크·설정 파일 위치, rl_games/offpolicy 요약. 정보를 빠르게 찾을 때 먼저 확인하세요.
